...
```
    $ git clone git@github.com:RedHatQuickCourses/architect-the-ocpvirt.git
```

2. Install the npm dependencies for the course tooling.
```
    $ cd architect-the-ocpvirt
    $ npm install
```
...
12. Verify that your changes have been published to the production GitHub pages website at https://redhatquickcourses.github.io/architect-the-ocpvirt

## Problems and Feedback
If you run into any issues, report bugs/suggestions/improvements about this course here - https://github.com/RedHatQuickCourses/architect-the-ocpvirt/issues
