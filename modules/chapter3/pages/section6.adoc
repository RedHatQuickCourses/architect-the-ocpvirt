...
//To make this sentence more clear, I would suggest recasting this phrase "failure domains are also defined" by using the active voice. That is, "We recommend that when deploying OpenShift Virtualization, [Someone] define failure domains at the physical architectural level...
